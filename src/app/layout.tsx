...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="bg-gradient-to-r from-slate-900 to-slate-700 font-sans">
      <head>
        <title>CramMaster - Your personal study assistant</title>
        <meta name="description" content="Your Personal Study Assitant"></meta>
