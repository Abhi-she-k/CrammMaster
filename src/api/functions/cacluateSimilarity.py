...
def calculateSimilarity(embeddings, question_embed, sentences):
    # Calculate similarities
    similarities = [F.cosine_similarity(torch.tensor(question_embed), torch.tensor(embed), dim=0) for embed in embeddings]
